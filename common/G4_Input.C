...
/*
 ...
 config_file = "/sphenix/user/cdean/public/forZhaozhong/phpythia8.cfg";
}
*/
}
...
void InputRegister()
{
  ...
  if (Input::PYTHIA8)
  {
    ...
    {
      AntiTrigger* myFinder = new AntiTrigger("AntiTrigger");
      myFinder->Verbosity(1);
      std::vector<std::string> particleList = {"D0", "D+", "Ds+", "Lambdac+", "J/psi", "psi(2S)", "B+", "B0", "Bs0", "Lambdab0"};
